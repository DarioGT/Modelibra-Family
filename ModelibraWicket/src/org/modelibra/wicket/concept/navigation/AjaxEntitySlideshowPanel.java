...
public abstract class AjaxEntitySlideshowPanel extends DmPanel {
	...
	public AjaxEntitySlideshowPanel(final ViewModel viewModel, final View view) {
		...
		playLink.add(new Image("play", PackageResource.get(this.getClass()
				.getSuperclass(), "media-playback-start.png")));
		...
		stopLink.add(new Image("stop", PackageResource.get(this.getClass()
				.getSuperclass(), "media-playback-stop.png")));
