 ...
 * @version 2007-11-28
 */
public class EntityDisplayTablePage extends DmDisplayPage {

	private static final long serialVersionUID = 102190L;
	...
	public EntityDisplayTablePage(final ViewModel viewModel, final View view) {
		...
		view.setPage(this);
		entityDisplayTablePanelView.setContextView(view);
