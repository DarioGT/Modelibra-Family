 ...
 * @version 2007-11-28
 */
public class EntityDisplayPage extends DmDisplayPage {

	private static final long serialVersionUID = 102140L;

	private static Log log = LogFactory.getLog(EntityDisplayPage.class);

	/**
	 * Constructs an entity display page.
	 * 
	 * @param viewModel
	 *            view model
	 * @param view
	 *            view
	 */
	public EntityDisplayPage(final ViewModel viewModel, final View view) {
