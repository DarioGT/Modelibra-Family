...
public abstract class DmPanel extends Panel {

	/**
	 * Constructs a dm panel.
	 * 
	 * @param wicketId
	 *            Wicket id
	 */
	public DmPanel(final String wicketId) {
		super(wicketId);
	}
	 ...
	 *            view
	 */
	public DmPanel(final ViewModel viewModel, final View view) {
