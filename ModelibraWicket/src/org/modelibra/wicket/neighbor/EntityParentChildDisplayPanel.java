...
/**
 * Entity Parent-Child display panel.
 * 
 * @author Vedad Kirlic
 * @version 2008-01-19
 */
public class EntityParentChildDisplayPanel extends EntityParentChildPanel {

	private static final long serialVersionUID = 1L;

	/**
	 * Constructs the EntityParentChildDisplayPanel.
	 * 
	 * @param viewModel
	 *            view model
	 * @param view
	 *            view
	 */
	public EntityParentChildDisplayPanel(final ViewModel viewModel,
			final View view) {
	...
	protected Panel getParentPanel(ViewModel viewModel, View view) {
		...
		return app.getViewMeta(model).getPanel("EntityDisplayPanel", viewModel,
				view);
	}
	...
	protected Panel getChildPanel(ViewModel viewModel, View view) {
		DomainApp app = (DomainApp) getApplication();
		String model = viewModel.getModel().getModelConfig().getCode();
		return app.getViewMeta(model).getPanel("EntityDisplayTablePanel",
				viewModel, view);
	}
