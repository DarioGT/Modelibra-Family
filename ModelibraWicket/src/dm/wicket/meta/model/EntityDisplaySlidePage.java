...
public class EntityDisplaySlidePage extends
	...
	private static final long serialVersionUID = 110110126L;
	...
	private static ViewModel getNewViewModel(final ViewModel viewModel) {
		...
		Models models = (Models) viewModel.getEntities();
		models = (Models) models.getModelsOrderedByCode();
		newViewModel.setEntities(models);
		return newViewModel;
	}
