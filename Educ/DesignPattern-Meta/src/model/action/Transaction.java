...
public class Transaction extends Action {
	...
	public boolean execute() {
		if (isStarted() || (isUndone())) {
			...
			throw new RuntimeException(
					"A transaction must be either started or undone to be executed.");
		}
	}
	...
	public boolean undo() {
		if (isExecuted()) {
			...
			throw new RuntimeException(
					"A transaction must be executed to be undone.");
		}
	}
	...
	public boolean redo() {
		if (isUndone()) {
			...
			throw new RuntimeException(
					"A transaction must be undone to be re-executed.");
		}
	}
