 ...
 * the License.
 */
package sales.wicket.cheesestore.address;
...
public class EntityDisplaySlidePage extends
	...
	private static final long serialVersionUID = 1231169511163L;
	...
	private static ViewModel getNewViewModel(final ViewModel viewModel) {
		...
		Addresses addresses = (Addresses) viewModel.getEntities();
		// addresses = addresses.getAddressesOrderedBy????(true);
		newViewModel.setEntities(addresses);
		return newViewModel;
	}
