...
/**
 * Patient specific entity.
 * 
 * @author Dzenan Ridjanovic
 * @version 2009-09-17
 */
public class Patient extends GenPatient {

	private static final long serialVersionUID = 1253218298656L;
	 ...
	 *            model
	 */
	public Patient(IDomainModel model) {
		super(model);
	}
