...
import medical.MedicalTest;

/**
 * JUnit tests for Patients.
 * 
...
public class PatientsTest {
	...
	public static void beforeTests() throws Exception {
		...
		// patients = MedicalTest.getSingleton().getMedical().getRecords().getPatients();
	}

	@Before
	public void beforeTest() throws Exception {
		patients.getErrors().empty();
	}
	...
	public static void afterTests() throws Exception {
		MedicalTest.getSingleton().close();
	}
