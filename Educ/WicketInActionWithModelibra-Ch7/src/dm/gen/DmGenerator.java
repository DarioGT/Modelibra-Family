...
public class DmGenerator {
	...
	public static final String DOMAIN_CODE = "Sales";
	...
	public static void main(String[] args) {
		...
		// *** Model changes
		 ...
		 .generateModelGenClass("CheeseStore");
//		 dmGenerator.getDmModelibraGenerator().generateConceptGenClasses(
//		 "CheeseStore", "UpdatedConcept");
//		 dmGenerator.getDmModelibraGenerator().generateConceptGenClasses(
//		 "CheeseStore", "NewConceptNeighbor");
		 dmGenerator.getDmModelibraGenerator().generateConceptClasses(
		 "CheeseStore", "Recipe");
//		 dmGenerator.getDmModelibraGenerator().generateConceptClasses(
//		 "CheeseStore", "NewConcept");
		 dmGenerator.getDmModelibraGenerator()
		 .generateEntryConceptEmptyXmlDataFile("CheeseStore",
		 "Recipe");
		...
		// OR
		 ...
		 .generateConceptPageClasses("CheeseStore", "Recipe");
