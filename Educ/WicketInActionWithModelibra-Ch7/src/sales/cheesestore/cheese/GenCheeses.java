...
/**
 * Cheese generated entities. This class should not be changed manually. Use a
...
public abstract class GenCheeses extends Entities<Cheese> {
	...
	/**
	 * Retrieves the cheese with a given oid. Null if not found.
	 * 
	 * @param oid
	 *            oid
	 * @return cheese
	...
	/**
	 * Retrieves the cheese with a given oid unique number. Null if not found.
	 * 
	...
	/**
	 * Retrieves the first cheese whose property with a property code is equal
	...
	/**
	 * Selects cheeses whose property with a property code is equal to a
	...
	/**
	 * Gets cheeses selected by a selector. Returns empty cheeses if there are
	 * no cheeses that satisfy the selector.
	 * 
	 * @param selector
	 *            selector
	 ...
	 * @return cheese
	 */
	public Cheese createCheese(String name, String description, Double price) {
