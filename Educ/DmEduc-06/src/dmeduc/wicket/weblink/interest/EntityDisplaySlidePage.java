...
public class EntityDisplaySlidePage extends
	...
	private static final long serialVersionUID = 1194454872537L;
	...
	private static ViewModel getNewViewModel(final ViewModel viewModel) {
		...
		Interests interests = (Interests) viewModel.getEntities();
		// interests = interests.getInterestsOrderedBy????(true);
		newViewModel.setEntities(interests);
		return newViewModel;
	}
