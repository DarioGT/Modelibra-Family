...
public class EntityDisplayListPage extends
	...
	private static final long serialVersionUID = 1176743350750L;
	...
	private static ViewModel getNewViewModel(final ViewModel viewModel) {
		...
		Documents documents = (Documents) viewModel.getEntities();
		// documents = documents.getDocumentsOrderedBy????(true);
		newViewModel.setEntities(documents);
		return newViewModel;
	}
