 ...
 * the License.
 */
package course.wicket.reference.countrylanguage;
...
public class EntityDisplayTablePage extends
	...
	private static final long serialVersionUID = 1176561912592L;
	...
	private static ViewModel getNewViewModel(final ViewModel viewModel) {
		...
		CountryLanguages countryLanguages = (CountryLanguages) viewModel
				.getEntities();
		// countryLanguages =
		// countryLanguages.getCountryLanguagesOrderedBy????(true);
