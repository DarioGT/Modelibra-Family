 ...
 * the License.
 */
package course.wicket.reference.questiontype;
...
public class EntityDisplaySlidePage extends
	...
	private static final long serialVersionUID = 1176746303139L;
	...
	private static ViewModel getNewViewModel(final ViewModel viewModel) {
		...
		QuestionTypes questionTypes = (QuestionTypes) viewModel.getEntities();
		// questionTypes = questionTypes.getQuestionTypesOrderedBy????(true);
		newViewModel.setEntities(questionTypes);
		return newViewModel;
	}
