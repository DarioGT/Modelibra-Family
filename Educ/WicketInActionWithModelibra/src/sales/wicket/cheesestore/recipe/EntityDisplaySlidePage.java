 ...
 * the License.
 */
package sales.wicket.cheesestore.recipe;
...
public class EntityDisplaySlidePage extends
	...
	private static final long serialVersionUID = 1236779109378L;
	...
	private static ViewModel getNewViewModel(final ViewModel viewModel) {
		...
		Recipes recipes = (Recipes) viewModel.getEntities();
		// recipes = recipes.getRecipesOrderedBy????(true);
		newViewModel.setEntities(recipes);
		return newViewModel;
	}
