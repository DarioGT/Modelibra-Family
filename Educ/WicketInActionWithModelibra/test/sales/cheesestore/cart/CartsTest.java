...
public class CartsTest {
	...
	public static void beforeTests() throws Exception {
		...
		// carts = SalesTest.getSingleton().getSales().getCheeseStore().getCarts();
	}

	@Before
	public void beforeTest() throws Exception {
		carts.getErrors().empty();
	}
