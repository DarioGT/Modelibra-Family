 ...
 * the License.
 */
package sales.wicket.cheesestore.cartcheese;
...
public class EntityDisplayTablePage extends
	...
	private static final long serialVersionUID = 1231169481737L;
	...
	private static ViewModel getNewViewModel(final ViewModel viewModel) {
		...
		CartCheeses cartCheeses = (CartCheeses) viewModel.getEntities();
		// cartCheeses = cartCheeses.getCartCheesesOrderedBy????(true);
		newViewModel.setEntities(cartCheeses);
		return newViewModel;
	}
