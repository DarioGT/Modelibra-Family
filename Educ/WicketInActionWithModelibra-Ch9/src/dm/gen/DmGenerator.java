...
public class DmGenerator {
	...
	public static void main(String[] args) {
		...
		dmGenerator.getDmModelibraGenerator().generateModelGenClass(
				"CheeseStore");
		dmGenerator.getDmModelibraGenerator().generateConceptGenClasses(
				"CheeseStore", "Cheese");
		dmGenerator.getDmModelibraGenerator().generateConceptGenClasses(
				"CheeseStore", "Discount");
		dmGenerator.getDmModelibraGenerator().generateConceptClasses(
				"CheeseStore", "Discount");
		dmGenerator
				.getDmModelibraGenerator()
				.generateEntryConceptEmptyXmlDataFile("CheeseStore", "Discount");
		...
		// .generateConceptPageClasses("CheeseStore", "Discount");
