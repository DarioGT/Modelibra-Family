...
public class EntityDisplaySlidePage extends
	...
	private static final long serialVersionUID = 1176413492944L;
	...
	private static ViewModel getNewViewModel(final ViewModel viewModel) {
		...
		Points points = (Points) viewModel.getEntities();
		// points = points.getPointsOrderedBy????(true);
		newViewModel.setEntities(points);
		return newViewModel;
	}
