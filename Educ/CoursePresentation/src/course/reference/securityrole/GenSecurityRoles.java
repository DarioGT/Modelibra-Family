...
public abstract class GenSecurityRoles extends Entities<SecurityRole> {
	...
	private static final long serialVersionUID = 1176561884334L;
	...
	/**
	 * Gets role securityRoles.
	 * 
	 * @param role
	 *            role
	 * @return role securityRoles
	 */
	public SecurityRoles getRoleSecurityRoles(String role) {
		PropertySelector propertySelector = new PropertySelector("role");
		propertySelector.defineEqual(role);
	...
	/**
	 * Gets securityRoles ordered by role.
	 * 
	 * @param ascending
	 *            <code>true</code> if ascending
	 * @return ordered securityRoles
	 */
	public SecurityRoles getSecurityRolesOrderedByRole(boolean ascending) {
		return getSecurityRoles("role", ascending);
	}
