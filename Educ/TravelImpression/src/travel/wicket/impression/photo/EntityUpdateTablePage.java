 ...
 * the License.
 */
package travel.wicket.impression.photo;
...
public class EntityUpdateTablePage extends
	...
	private static final long serialVersionUID = 1189698236082L;
	...
	private static ViewModel getNewViewModel(final ViewModel viewModel) {
		...
		Photos photos = (Photos) viewModel.getEntities();
		// photos = photos.getPhotosOrderedBy????(true);
		newViewModel.setEntities(photos);
		return newViewModel;
	}
