...
/**
 * Message specific entity.
 * 
 * @author Dzenan Ridjanovic
 * @version 2007-09-18
 */
public class Message extends GenMessage {

	private static final long serialVersionUID = 1189698214196L;
	 ...
	 *            model
	 */
	public Message(IDomainModel model) {
		super(model);
	}
	 ...
	 *            traveler
	 */
	public Message(Traveler traveler) {
		super(traveler);
	}
