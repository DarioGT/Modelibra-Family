...
public class DmModelibraGenerator {
	...
	private static Log log = LogFactory.getLog(DmModelibraGenerator.class);
	...
	private String codeDirectoryPath;
	...
	public DmModelibraGenerator(String domainCode, String domainType) {
		try {
			...
			codeDirectoryPath = modelibraGenerator.getSourceDirectoryPath();
			testDirectoryPath = modelibraGenerator.getTestDirectoryPath();
		} catch (Exception e) {
			log.error("Error in DmModelibraGenerator.constructor: "
					+ e.getMessage());
		}
	}
