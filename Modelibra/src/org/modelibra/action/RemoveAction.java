...
/**
 * Encapsulates the remove action on entities.
 * 
...
public class RemoveAction extends EntitiesAction {
	...
	/**
	 * Constructs entities remove action within a session.
	 * 
	 * @param session
	 *            session
	 */
	public RemoveAction(ModelSession session) {
		super(session);
	}

	/**
	 * Constructs entities remove action within a transaction.
	 * 
	 * @param transaction
	 *            transaction
	 */
	public RemoveAction(Transaction transaction) {
		super(transaction);
	}
	 ...
	 * 
	 * @param entities
	 *            entities on which to execute action - remove entity
	 * 
	 * @param entity
	 *            entity to be used in action - removed from entities
	 */
	public RemoveAction(ModelSession session, IEntities<?> entities,
			IEntity<?> entity) {
	 ...
	 *            entity to be used in action - removed from entities
	 */
	public RemoveAction(Transaction transaction, IEntities<?> entities,
			IEntity<?> entity) {
		super(transaction, entities, entity);
	}

	/**
	 * Constructs entities remove action. This kind of action will never be
