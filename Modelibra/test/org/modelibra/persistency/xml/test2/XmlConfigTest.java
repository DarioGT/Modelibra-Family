...
public class XmlConfigTest {
	...
	public void getModelibraProperties() throws Exception {
		ModelibraProperties modelibraProperties = xmlConfig
	...
	public void getDomainConfig() throws Exception {
		DomainConfig domainConfig = xmlConfig.getDomainConfig("Xml",
				"Specific");
	...
	public void getDataRelativePath() throws Exception {
		...
		String pathFromModelConfig = "test/org/modelibra/persistency/xml/test2";
