...
public class Member extends GenMember {
	...
	/**
	 * Copies applicant properties to this member properties.
	 * 
	 * @param applicant
	 *            applicant
	 */
	public void copyFromApplicant(Applicant applicant) {
		setCode(applicant.getCode());
		...
		setReceiveEmail(applicant.getReceiveEmail());
	}
