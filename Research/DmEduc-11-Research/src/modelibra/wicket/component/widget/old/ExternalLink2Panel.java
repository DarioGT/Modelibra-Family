...
/**
 * External link 2 panel: property header and value.
 */
@SuppressWarnings("serial")
public class ExternalLink2Panel extends ExternalLinkPanel {
	 ...
	 *            property view
	 */
	public ExternalLink2Panel(final PropertyView propertyView) {
		super(propertyView);
