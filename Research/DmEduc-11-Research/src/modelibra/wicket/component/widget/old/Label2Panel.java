...
/**
 * Label 2 panel: property header and value.
 */
@SuppressWarnings("serial")
public class Label2Panel extends LabelPanel {

	/**
	 * Constructs a label 2 panel.
	 * 
	 * @param propertyView
	 *            property view
	 */
	public Label2Panel(final PropertyView propertyView) {
		super(propertyView);
