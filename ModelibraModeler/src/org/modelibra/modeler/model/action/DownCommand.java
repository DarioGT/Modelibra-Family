...
public class DownCommand extends Command {
	...
	public DownCommand(Transaction aTransaction, EntityModel parent,
	...
	/*
	 * private void executeDownCommand() { log(); basicDo(); if (done)
	 * parent.notifyObservers(new ModelEvent("moveDown", parentChildrenName, new
	 * Integer(currentPosition))); }
	 */

	private void undoDownCommand() {
		basicUndo();
		if (undone)
