...
public class DmGenerator {
	...
	public static final String DOMAIN_CODE = "Twoadw";
	...
	public static void main(String[] args) {
		...
		dmGenerator.getDmModelibraGenerator().generateConceptGenClasses("Website", "Question");
		dmGenerator.getDmModelibraGenerator().generateConceptGenClasses("Website", "InvoiceStatus");
