 ...
 * the License.
 */
package twoadw.wicket.reference.countrylanguage;
...
public class EntityDisplayTablePage extends
	...
	private static final long serialVersionUID = 1236723103074L;
	...
	private static ViewModel getNewViewModel(final ViewModel viewModel) {
		...
		// countryLanguages = countryLanguages.getCountryLanguagesOrderedBy????(true);
