 ...
 * the License.
 */
package twoadw.wicket.website.specificationcategory;
...
public class EntityUpdateTablePage extends
	...
	private static final long serialVersionUID = 1236796091296L;
	...
	private static ViewModel getNewViewModel(final ViewModel viewModel) {
		...
		SpecificationCategories specificationCategories = (SpecificationCategories) viewModel.getEntities();
		// specificationCategories = specificationCategories.getSpecificationCategoriesOrderedBy????(true);
		newViewModel.setEntities(specificationCategories);
		return newViewModel;
	}
