 ...
 * the License.
 */
package twoadw.wicket.website.invoiceproduct;
...
public class EntityDisplayListPage extends
	...
	private static final long serialVersionUID = 1234213515635L;
	...
	private static ViewModel getNewViewModel(final ViewModel viewModel) {
		...
		InvoiceProducts invoiceProducts = (InvoiceProducts) viewModel.getEntities();
		// invoiceProducts = invoiceProducts.getInvoiceProductsOrderedBy????(true);
		newViewModel.setEntities(invoiceProducts);
		return newViewModel;
	}
