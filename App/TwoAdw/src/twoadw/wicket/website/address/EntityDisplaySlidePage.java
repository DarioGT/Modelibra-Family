 ...
 * the License.
 */
package twoadw.wicket.website.address;
...
public class EntityDisplaySlidePage extends
	...
	private static final long serialVersionUID = 1234726511680L;
	...
	private static ViewModel getNewViewModel(final ViewModel viewModel) {
		...
		Addresss addresss = (Addresss) viewModel.getEntities();
		// addresss = addresss.getAddresssOrderedBy????(true);
		newViewModel.setEntities(addresss);
		return newViewModel;
	}
