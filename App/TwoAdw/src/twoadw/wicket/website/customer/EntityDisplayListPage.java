 ...
 * the License.
 */
package twoadw.wicket.website.customer;
...
public class EntityDisplayListPage extends
	...
	private static final long serialVersionUID = 1234213586158L;
	...
	private static ViewModel getNewViewModel(final ViewModel viewModel) {
		...
		Customers customers = (Customers) viewModel.getEntities();
		// customers = customers.getCustomersOrderedBy????(true);
		newViewModel.setEntities(customers);
		return newViewModel;
	}
