 ...
 * the License.
 */
package twoadw.wicket.website.invoice;
...
public class EntityDisplaySlidePage extends
	...
	private static final long serialVersionUID = 1234213538121L;
	...
	private static ViewModel getNewViewModel(final ViewModel viewModel) {
		...
		Invoices invoices = (Invoices) viewModel.getEntities();
		// invoices = invoices.getInvoicesOrderedBy????(true);
		newViewModel.setEntities(invoices);
		return newViewModel;
	}
