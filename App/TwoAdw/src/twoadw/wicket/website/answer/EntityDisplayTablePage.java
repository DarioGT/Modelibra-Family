 ...
 * the License.
 */
package twoadw.wicket.website.answer;
...
public class EntityDisplayTablePage extends
	...
	private static final long serialVersionUID = 1236739076037L;
	...
	private static ViewModel getNewViewModel(final ViewModel viewModel) {
		...
		Answers answers = (Answers) viewModel.getEntities();
		// answers = answers.getAnswersOrderedBy????(true);
		newViewModel.setEntities(answers);
		return newViewModel;
	}
