 ...
 * the License.
 */
package twoadw.wicket.website.productcategory;
...
public class EntityDisplayTablePage extends
	...
	private static final long serialVersionUID = 1234725304099L;
	...
	private static ViewModel getNewViewModel(final ViewModel viewModel) {
		...
		ProductCategories productCategories = (ProductCategories) viewModel.getEntities();
		// productCategories = productCategories.getProductCategoriesOrderedBy????(true);
		newViewModel.setEntities(productCategories);
		return newViewModel;
	}
