 ...
 * the License.
 */
package twoadw.wicket.website.productcomment;
...
public class EntityDisplayTablePage extends
	...
	private static final long serialVersionUID = 1234728771943L;
	...
	private static ViewModel getNewViewModel(final ViewModel viewModel) {
		...
		ProductComments productComments = (ProductComments) viewModel.getEntities();
		// productComments = productComments.getProductCommentsOrderedBy????(true);
		newViewModel.setEntities(productComments);
		return newViewModel;
	}
