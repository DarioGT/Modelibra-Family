 ...
 * the License.
 */
package twoadw.wicket.website.qqcategory;
...
public class EntityUpdateTablePage extends
	...
	private static final long serialVersionUID = 1236975992804L;
	...
	private static ViewModel getNewViewModel(final ViewModel viewModel) {
		...
		QQCategories qQCategories = (QQCategories) viewModel.getEntities();
		// qQCategories = qQCategories.getQQCategoriesOrderedBy????(true);
		newViewModel.setEntities(qQCategories);
		return newViewModel;
	}
