 ...
 * the License.
 */
package twoadw.wicket.website.questioncategory;
...
public class EntityDisplaySlidePage extends
	...
	private static final long serialVersionUID = 1236738768967L;
	...
	private static ViewModel getNewViewModel(final ViewModel viewModel) {
		...
		QuestionCategories questionCategories = (QuestionCategories) viewModel.getEntities();
		// questionCategories = questionCategories.getQuestionCategoriesOrderedBy????(true);
		newViewModel.setEntities(questionCategories);
		return newViewModel;
	}
