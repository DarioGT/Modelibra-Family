 ...
 * the License.
 */
package twoadw.wicket.website.product;
...
public class EntityDisplayListPage extends
	...
	private static final long serialVersionUID = 1234213171470L;
	...
	private static ViewModel getNewViewModel(final ViewModel viewModel) {
		...
		Products products = (Products) viewModel.getEntities();
		// products = products.getProductsOrderedBy????(true);
		newViewModel.setEntities(products);
		return newViewModel;
	}
