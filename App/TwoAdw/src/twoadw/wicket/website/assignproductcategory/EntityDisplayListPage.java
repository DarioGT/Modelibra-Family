 ...
 * the License.
 */
package twoadw.wicket.website.assignproductcategory;
...
public class EntityDisplayListPage extends
	...
	private static final long serialVersionUID = 1237227206435L;
	...
	private static ViewModel getNewViewModel(final ViewModel viewModel) {
		...
		AssignProductCategories assignProductCategories = (AssignProductCategories) viewModel.getEntities();
		// assignProductCategories = assignProductCategories.getAssignProductCategoriesOrderedBy????(true);
		newViewModel.setEntities(assignProductCategories);
		return newViewModel;
	}
