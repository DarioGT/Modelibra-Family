 ...
 * the License.
 */
package twoadw.wicket.website.specification;
...
public class EntityDisplayListPage extends
	...
	private static final long serialVersionUID = 1236796162015L;
	...
	private static ViewModel getNewViewModel(final ViewModel viewModel) {
		...
		Specifications specifications = (Specifications) viewModel.getEntities();
		// specifications = specifications.getSpecificationsOrderedBy????(true);
		newViewModel.setEntities(specifications);
		return newViewModel;
	}
