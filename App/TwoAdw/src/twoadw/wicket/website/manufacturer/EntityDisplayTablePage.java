 ...
 * the License.
 */
package twoadw.wicket.website.manufacturer;
...
public class EntityDisplayTablePage extends
	...
	private static final long serialVersionUID = 1234727536428L;
	...
	private static ViewModel getNewViewModel(final ViewModel viewModel) {
		...
		Manufacturers manufacturers = (Manufacturers) viewModel.getEntities();
		// manufacturers = manufacturers.getManufacturersOrderedBy????(true);
		newViewModel.setEntities(manufacturers);
		return newViewModel;
	}
