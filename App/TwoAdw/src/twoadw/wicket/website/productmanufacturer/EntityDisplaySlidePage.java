 ...
 * the License.
 */
package twoadw.wicket.website.productmanufacturer;
...
public class EntityDisplaySlidePage extends
	...
	private static final long serialVersionUID = 1234729930227L;
	...
	private static ViewModel getNewViewModel(final ViewModel viewModel) {
		...
		ProductManufacturers productManufacturers = (ProductManufacturers) viewModel.getEntities();
		// productManufacturers = productManufacturers.getProductManufacturersOrderedBy????(true);
		newViewModel.setEntities(productManufacturers);
		return newViewModel;
	}
