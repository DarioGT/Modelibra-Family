 ...
 * the License.
 */
package twoadw.wicket.website.productrebate;
...
public class EntityDisplaySlidePage extends
	...
	private static final long serialVersionUID = 1236704565612L;
	...
	private static ViewModel getNewViewModel(final ViewModel viewModel) {
		...
		ProductRebates productRebates = (ProductRebates) viewModel.getEntities();
		// productRebates = productRebates.getProductRebatesOrderedBy????(true);
		newViewModel.setEntities(productRebates);
		return newViewModel;
	}
