 ...
 * the License.
 */
package twoadw.wicket.generic.link;
...
public class EntityUpdateTablePage extends
	...
	private static final long serialVersionUID = 1236708354136L;
	...
	private static ViewModel getNewViewModel(final ViewModel viewModel) {
		...
		Links links = (Links) viewModel.getEntities();
		// links = links.getLinksOrderedBy????(true);
		newViewModel.setEntities(links);
		return newViewModel;
	}
