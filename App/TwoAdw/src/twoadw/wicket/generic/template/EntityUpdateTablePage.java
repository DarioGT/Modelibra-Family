 ...
 * the License.
 */
package twoadw.wicket.generic.template;
...
public class EntityUpdateTablePage extends
	...
	private static final long serialVersionUID = 1236796790481L;
	...
	private static ViewModel getNewViewModel(final ViewModel viewModel) {
		...
		Templates templates = (Templates) viewModel.getEntities();
		// templates = templates.getTemplatesOrderedBy????(true);
		newViewModel.setEntities(templates);
		return newViewModel;
	}
