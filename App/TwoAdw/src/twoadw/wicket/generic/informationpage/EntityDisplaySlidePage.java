 ...
 * the License.
 */
package twoadw.wicket.generic.informationpage;
...
public class EntityDisplaySlidePage extends
	...
	private static final long serialVersionUID = 1236708441728L;
	...
	private static ViewModel getNewViewModel(final ViewModel viewModel) {
		...
		InformationPages informationPages = (InformationPages) viewModel.getEntities();
		// informationPages = informationPages.getInformationPagesOrderedBy????(true);
		newViewModel.setEntities(informationPages);
		return newViewModel;
	}
