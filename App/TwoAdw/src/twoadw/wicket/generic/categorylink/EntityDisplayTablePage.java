 ...
 * the License.
 */
package twoadw.wicket.generic.categorylink;
...
public class EntityDisplayTablePage extends
	...
	private static final long serialVersionUID = 1236708297993L;
	...
	private static ViewModel getNewViewModel(final ViewModel viewModel) {
		...
		CategoryLinks categoryLinks = (CategoryLinks) viewModel.getEntities();
		// categoryLinks = categoryLinks.getCategoryLinksOrderedBy????(true);
		newViewModel.setEntities(categoryLinks);
		return newViewModel;
	}
