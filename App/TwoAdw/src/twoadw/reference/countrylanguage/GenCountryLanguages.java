...
/**
 * CountryLanguage generated entities. This class should not be changed manually. 
...
public abstract class GenCountryLanguages extends Entities<CountryLanguage> {
	...
	private static final long serialVersionUID = 1236723103070L;
...
/**
 * Retrieves the countryLanguage with a given oid. 
 * Null if not found. 
	 * 
	 * @param oid
	 *            oid
...
public CountryLanguage getCountryLanguage(Oid oid) {
	...
	/**
 * Retrieves the countryLanguage with a given oid unique number. 
 * Null if not found. 
	 * 
...
/**
 * Retrieves the first countryLanguage whose property with a  
 * property code is equal to a property object. Null if not found. 
	 ...
	 * @return countryLanguage
	 */
	public CountryLanguage getCountryLanguage(String propertyCode, Object property) {
		return retrieveByProperty(propertyCode, property);
	}
	
			
		/**
	 * Selects countryLanguages whose property with a property code is equal to a property
	 ...
	 */
	public CountryLanguages getCountryLanguages(String propertyCode, Object property) {
	 ...
	 */
	public CountryLanguages getCountryLanguages(String propertyCode, boolean ascending) {
	...
	/**
	 * Gets countryLanguages selected by a selector. Returns empty countryLanguages if there are no
	 * countryLanguages that satisfy the selector.
	 * 
	 * @param selector
	 *            selector
	 ...
	 * @return ordered countryLanguages
	 */
	public CountryLanguages getCountryLanguages(Comparator comparator, boolean ascending) {
	...
	/**
		 ...
		 * @return ordered countryLanguages
		 */
		public CountryLanguages getCountryLanguagesOrderedByLanguage(boolean ascending) {			
