...
/**
 * Answer generated entity. This class should not be changed manually. 
 * Use a subclass to add specific code.
 * 
 * @author TeamFcp
 * @version 2009-03-16
 */
public abstract class GenAnswer extends Entity<Answer> {

	private static final long serialVersionUID = 1236739076032L;

	private static Log log = LogFactory.getLog(GenAnswer.class);
	 ...
	 *            model
	 */
	public GenAnswer(IDomainModel model) {
		super(model);
